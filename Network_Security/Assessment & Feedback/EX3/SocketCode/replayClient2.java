...
public class replayClient2
{
        ...
        public static void main(String[] args) throws Exception {
            ...
            System.out.println(byteArrayToHexString(encSNounce));

//            byte[] srvNInc = new byte[16]; // TODO: 自己获取一下
//            outputStream.write(srvNInc);
//
//            int avail = inputStream.available();
//            byte[] anS = new byte[avail];
//            inputStream.read(anS);
//            byte[] ssss=  decAESsessionCipher.doFinal(anS);
